...
public final class BlockProperties {
    ...
    public static final class Builder {
        ...
        private String drawType = "Model";
        private String material = "Solid";
        private String opacity = "Transparent";
        private String blockSoundSetId = "Wood";
        private String hitboxType = "Plant_Full";
        ...
        private String itemPlayerAnimationsId = "Block";
        private String itemSoundSetId = "ISS_Blocks_Wood";
        private String itemQuality;
        private Integer itemLevel;

        private Builder() {
            itemCategories.add("Blocks.Custom");
        }
        ...
        public BlockProperties build() {
            if (model == null) {
                throw new IllegalArgumentException("BlockProperties.build() requires model(...).");
            }
            if (texture == null) {
                throw new IllegalArgumentException("BlockProperties.build() requires texture(...).");
            }
